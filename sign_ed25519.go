...
// Ed25519SigningAlgorithm, which uses compressor given to prevent buffering data before signing.
// This allows for easier signing of arbitrarily sized data.
type Ed25519SigningAlgorithm struct {
	Compressor SigningKey
}

func (a *Ed25519SigningAlgorithm) GetInfo() SignAlgoInfo {
	return SignAlgoInfo{
...
func (a *Ed25519SigningAlgorithm) GenerateKeyPair(ctx KeyGenerationContext) (sk SigningKey, vk VerifyingKey, err error) {
...
func (a *Ed25519SigningAlgorithm) ParseSigningKey(ctx KeyParseContext, key []byte) (sk SigningKey, err error) {
...
func (a *Ed25519SigningAlgorithm) ParseVerifyingKey(ctx KeyParseContext, key []byte) (vk VerifyingKey, err error) {
...
func RegisterEd25519(reg Registry, options RegisterEd25519Options) {
	...
	for _, config := range options.CompressorData {
		...
		reg.RegisterAlgo("ed25519-"+config.Suffix, Ed25519SigningAlgorithm{
